...
initMap();
    ...
    var placeSearchInput= document.getElementById('placeSearch');
    if(placeSearchInput){
		placeSearchInput.addEventListener('input', function(){
			var searchText= placeSearchInput.value;
			service.textSearch({query: searchText}, function(results, status){
