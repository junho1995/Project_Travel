...
<div class="post-container">
	<div class="search-container">
		<input type="text" placeholder="#해시태그로 검색해보세요..." id="search-input"
			class="user-font user-text-color">
		<!-- 사용자 폰트 및 텍스트 색상 적용 -->
...
<div class="sidebar">
	<ul>
		<li><a href="../jsp/postMake.jsp" class="user-text-color">게시물
				만들기</a></li>
		<!-- 게시물 만들기 버튼에 텍스트 색상 적용 -->
		<li><a href="../jsp/talk.jsp" class="user-text-color">톡(TALK)</a></li>
...
<div class="post-container">
	...
	<div class="instagram-post">
		<div class="profile">
			<img src="../images/profile.jpg" alt="프로필 사진"> <span
				class="username user-font user-text-color">username1</span>
		</div>
...
<div class="post-container">
	<div class="instagram-post">
		<div class="profile">
			<img src="../images/profile.jpg" alt="프로필 사진"> <span
				class="username user-font user-text-color">username2</span>
		</div>
		<div class="post-content">
