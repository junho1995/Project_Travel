...
public class ItineraryController {
 ...
 // 수정된 일정의 목적지 정보를 업데이트하는 PUT 매핑
    ...
    public ResponseEntity<String> updateDestination(@PathVariable int planNo,
        ...
        // HTTP 상태 코드와 함께 응답을 반환
        return ResponseEntity.status(HttpStatus.OK).body("Successfully updated itinerary with planNo: " + planNo);
    }
    
    @DeleteMapping("/itinerary/delete/{planNo}")
    public ResponseEntity<String> deletePlan(@PathVariable int planNo){
    	this.planservice.deletePlanByPlanNo(planNo);
